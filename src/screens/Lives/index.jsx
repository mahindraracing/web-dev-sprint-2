...
export default function Lives() {
  ...
  return (
    ...
    >
      ...
      <motion.section variants={itemVariants}>
        <h2 className={`text-4xl font-semibold mb-6 ${theme === 'dark' ? 'text-gray-100' : 'text-gray-800'}`}>New Post</h2>
        <motion.form 
          onSubmit={handleSubmit} 
          className={`p-6 border rounded-lg shadow-lg ${theme === 'dark' ? 'border-gray-700 bg-gray-800' : 'border-gray-300 bg-white'}`}
