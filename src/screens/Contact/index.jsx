    ...
    <div className={`min-h-screen ${theme === 'dark' ? 'bg-gray-900 text-gray-100' : 'bg-white text-gray-800'} overflow-hidden`}>
      ...
      <div className="relative z-10 container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          <motion.h1
            className={`text-5xl font-bold mb-8 text-center ${theme === 'dark' ? 'text-gray-100' : 'text-gray-900'}`}
            variants={fadeInDown}
            initial="hidden"
            animate="visible"
          >
            ...
            >
              <Card className={`bg-${theme === 'dark' ? 'gray-800' : 'white'} border-${theme === 'dark' ? 'gray-700' : 'gray-200'} shadow-lg`}>
                ...
                <CardContent>
                  ...
                  {isSubmitted && (
                    <motion.div
                      className={`mt-4 p-4 ${theme === 'dark' ? 'bg-green-800 text-green-100' : 'bg-green-100 text-green-800'} rounded-md`}
                      initial={{ opacity: 0 }}
                    ...
                    <div className="flex justify-center space-x-4">
                      {['facebook', 'twitter', 'instagram', 'youtube'].map((social) => (
                        <Button
                          ...
                          variant="outline"
                          size="icon"
                          className={`bg-${theme === 'dark' ? 'gray-700' : 'white'} text-${theme === 'dark' ? 'gray-100' : 'black'} border-${theme === 'dark' ? 'gray-600' : 'gray-300'} hover:bg-red-600 hover:text-white transition-colors`}
                        >
